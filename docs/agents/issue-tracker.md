...
Check whether `.scratch/` is gitignored in the repo you're standing in. If it is not, ask the
user whether tickets should be committed before creating the first one.
