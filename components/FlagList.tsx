 ...
 *
 * Nothing is sorted here. Flags arrive from the seam unordered and are rendered in
 * that order, because ticket 06 owns ranking and a list that looked ranked before it
 * lands would hide whether ranking works. The note in the list says so, and goes when
 * the order does.
 *
  ...
  return (
    <>
      <p className="flags__note">
        This list is not in order yet. Go by the severity word rather than the
        position.
      </p>
